...
class HomeViewController: UIViewController, AWSCognitoAuthDelegate {
...
//        }
        ...
        let token = aWSCognitoIdentityGetOpenIdTokenResponse?.token
        print("aWSCognitoIdentityGetOpenIdTokenResponse?.token?", token as Any)
        let identityIdq = aWSCognitoIdentityGetOpenIdTokenResponse?.identityId?.description
        print("aWSCognitoIdentityGetOpenIdTokenResponse?.identityId?", identityIdq as Any)
    }
...
//        let signInProviderClass: AnyClass? = nil
//        var providerArray: [AnyHashable]
//        providerArray = [AWSSignInProvider?]()
...
//
//        if !signInProviderKeyDictionary {
